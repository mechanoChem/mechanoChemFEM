    ...
    //for (;cell!=endc; ++cell){
      //if (cell->subdomain_id() == this->this_mpi_process){
        ...
        //for (unsigned int i = 0; i < GeometryInfo<dim>::vertices_per_cell; ++i) {
          ...
          //double dh = 1.0e12;
          //int origin_index = -1;
          //double radius_shift = 1.0;
          //for (unsigned int o1=0;o1<origin_list_json.size();o1++){
            //Point<dim> origin(origin_list_json[o1][0],origin_list_json[o1][1]);
            //double radius = origin_list_json[o1][2] + radius_shift;
            ...
            //}
          //}
          //double val = iso_value + origin_list_json[origin_index][2] + radius_shift - distance;
        ...
        //unsigned int binder_id = 4;
        //// this comes first
        //if (cell->material_id() == binder_id)
        //{

          //unsigned int more_binder_id = 5;
          //if (all_greater) cell->set_material_id(more_binder_id);
        //}
        //if (cell->material_id() == electrolyte_id)
        //{
          //if (all_greater) cell->set_material_id(binder_id);
        //}
      //} // this_mpi_process
    //}
  //}
