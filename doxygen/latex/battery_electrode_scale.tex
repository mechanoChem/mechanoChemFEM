...
\textcolor{keyword}{set} dt = 10
\textcolor{keyword}{set} totalTime = 370
\textcolor{keyword}{set} step\_load = \textcolor{keyword}{false}

\textcolor{keyword}{set} first\_domain\_id = 0
\textcolor{keyword}{set} electrode\_id=0
\textcolor{keyword}{set} separator\_id=1

\textcolor{keyword}{set} electrode\_fe=0
\textcolor{keyword}{set} separator\_fe=1
...
\textcolor{keyword}{set} IpA = -100
end

\textcolor{preprocessor}{# some useful geometry information beforehand}
subsection Geometry
\textcolor{keyword}{set} X\_0 = 0
\textcolor{keyword}{set} Y\_0 = 0
\textcolor{keyword}{set} Z\_0 = 0
\textcolor{keyword}{set} X\_end = 120
\textcolor{keyword}{set} Y\_end = 120
\textcolor{keyword}{set} Z\_end = 85

\textcolor{keyword}{set} electrode\_Y1 = 60
\textcolor{keyword}{set} electrode\_Y2 = 80
