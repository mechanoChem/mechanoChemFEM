...
\DoxyCodeLine{set primary\_variables\_list= c1, component\_is\_scalar , u, component\_is\_vector}
\DoxyCodeLine{set FE\_support\_list= 1,0,  1,1}
\DoxyCodeLine{}
...
\DoxyCodeLine{set save\_snapshot = \textcolor{keyword}{true}}
\DoxyCodeLine{}
...
\DoxyCodeLine{set element\_div\_z=8 \#no need to 2D}
\DoxyCodeLine{end}
\DoxyCodeLine{}
...
\DoxyCodeLine{set out\_flux=-0.1}
\DoxyCodeLine{end}
\DoxyCodeLine{                        }
...
\DoxyCodeLine{        set absolute\_norm\_tolerance = 1.0e-10}
