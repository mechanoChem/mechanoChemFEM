...
The code is very similar to \mbox{\hyperlink{battery_electrode_scale}{Battery model at electrode scale}}. Here we mainly discuss how to apply interface condition and apply constraints during solve step.
...
\end{DoxyCode}
  ...
  The complete implementaion can be found at \href{https://github.com/mechanoChem/mechanoChemFEM/tree/example/Battery%20model%20at%20particle%20scale}{\texttt{ Github}}. 