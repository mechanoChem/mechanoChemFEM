...
\begin{DoxyCode}{0}
\DoxyCodeLine{solveClass< dim, matrixType, vectorType > and FEMdata< dim, vectorType >}
\end{DoxyCode}
...
\index{hpFEM$<$ dim $>$@{hpFEM$<$ dim $>$}!constraints@{constraints}}
\index{constraints@{constraints}!hpFEM$<$ dim $>$@{hpFEM$<$ dim $>$}}
