...
\DoxyCodeLine{\}}
\end{DoxyCode}
 The complete implementaion can be found at \href{https://github.com/mechanoChem/mechanoChemFEM/tree/example/Example1_diffusion_eaction}{\texttt{ Github}}.\hypertarget{growth_file}{}\section{User interface\+: parameter file}\label{growth_file}
